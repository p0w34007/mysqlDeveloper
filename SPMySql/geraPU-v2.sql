...
while count <= count1 do
      ...
      set dado5 = if((count=count1 or dado4 is null or dado4='' or dado4='/' or dado4='*' or dado4='.'),'',dado5);      
      select replace((replace((replace((replace((replace(dados,'?','')),' ','')),'*','')),'.','')),'/','') into dado6 from debug2;
