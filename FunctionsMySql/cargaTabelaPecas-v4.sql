...
*/
replace into pecas
(pu,marca_id,partnumber,puc,preco_fornecedor_id,preco_fornecedor,preco,moeda_preco,mostra_preco,oferta,origem,origem_id,data_cadastro,tem_fornecedor,quantidade,p3,p3_min,p7,p7_min,p12,p18)
select      
pu,marca_id,partnumber,puc,fornecedor_id,preco,preco,
moeda_preco,mostra_preco,oferta,'F',historico_id,data_cotacao,1,qtd,p3,
